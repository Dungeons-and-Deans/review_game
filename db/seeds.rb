...
GameSession.create!(game_id: 1, turn_group_id: 1, name: "First Period", icon_id: 4)
GameSession.create!(game_id: 1, turn_group_id: 3, name: "Second Period", icon_id: 5)
GameSession.create!(game_id: 2, turn_group_id: 5, name: "Third Period", icon_id: 6)
GameSession.create!(game_id: 3, turn_group_id: 7, name: "Fouth Period", icon_id: 7)
